...
selplo <- reactive({
  ...
  out <- subplot(
    # TODO: do this only for the parameters that have data
    make_plot(epcdata, 'Chlorophyll a', 'Concentration (ug/L)', "epchc_station", selsit),
    make_plot(epcdata, 'Ammonium (N)', 'Concentrationj (mg/L)', "epchc_station", selsit),
    make_plot(epcdata, 'Nitrate-Nitrite (N)', 'Concentration (mg/L)', station_colname, selsit),
    make_plot(epcdata, 'Nitrite (N)', 'Concentration (mg/L)', station_colname, selsit),
    make_plot(epcdata, 'Nitrate (N)', 'Concentration (mg/L)', station_colname, selsit),
    make_plot(epcdata, 'Orthophosphate (P)', 'Concentration (mg/L)', station_colname, selsit),
    make_plot(epcdata, 'Silica', 'Concentration (mg/L)', station_colname, selsit),
    # TODO: these are only commented out because there is no data for the default site
    # make_plot(epcdata, 'Nitrogen- Total', '(mg N/L)', station_colname, selsit),
    # make_plot(epcdata, 'Nitrogen- Total Kjeldahl (P)', '(mg/L)', station_colname, selsit),
    # make_plot(epcdata, 'Phosphorus- Total', 'Concentration (mg/L)', station_colname, selsit),
    # make_plot(epcdata, 'Turbidity', 'NTU', station_colname, selsit),
