...
wq_plo <- reactive({
  ...
  out <- subplot(
    make_plot(epcdata, 'Silicate', 'Silica \n mg/L', selsit),
    make_plot(epcdata, 'Chlorophyll_a', 'Chlor-a \n ug/L', selsit),
...
nitro_plo <- reactive({
  ...
  out <- subplot(
    ...
    # make_plot(epcdata, 'Nitrate+Nitrite', 'mg/L', selsit),
    # make_plot(epcdata, 'Nitrite', 'mg/L', selsit),
    # make_plot(epcdata, 'Nitrate', 'mg/L', selsit),
    make_plot(epcdata, 'Total_Nitrogen', 'Nitrogen \n mg N/L', selsit),
    make_plot(epcdata, 'Total_Kjeldahl_Nitrogen', 'Kjeldahl N mg/L', selsit),
    # nrows must equal the number of make_plot() calls above
    nrows = 3,
    shareX = T, shareY = F, titleX = T, titleY = T, which_layout = 1
...
phos_plo <- reactive({
  ...
  station_colname <- 'epchc_station'
  out <- subplot(
    make_plot(epcdata, 'Orthophosphate', 'Orthophosph. \n mg/L', selsit),
    make_plot(epcdata, 'Phosphorus', 'Phosphorus \n mg/L', selsit),
    # nrows must equal the number of make_plot() calls above
    nrows = 2,
    shareX = T, shareY = F, titleX = T, titleY = T, which_layout = 1
