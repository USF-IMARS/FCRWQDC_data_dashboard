...
nitro_plo <- reactive({
  ...
  out <- subplot(
    make_plot(epcdata, 'Ammonium', 'Ammonium \n mg/L', selsit),
    # make_plot(epcdata, 'NO2+3, Filtered', 'mg/L', selsit),
    # make_plot(epcdata, 'Nitrite', 'mg/L', selsit),
    # make_plot(epcdata, 'Nitrate', 'mg/L', selsit),
...
phos_plo <- reactive({
  ...
  station_colname <- 'epchc_station'
  out <- subplot(
    make_plot(epcdata, 'Orthophosphate', 'Phosphate \n mg/L', selsit),
