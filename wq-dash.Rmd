...
selplo <- reactive({
  ...
  out <- subplot(
    make_plot(epcdata, 'Chlorophyll a', 'ug/L', "epchc_station", selsit),
    make_plot(epcdata, 'Ammonium (N)', 'mg/L', "epchc_station", selsit),
    ...
    make_plot(epcdata, 'Orthophosphate (P)', 'mg/L', station_colname, selsit),
    make_plot(epcdata, 'Silica', 'mg/L', station_colname, selsit),
    ...
    make_plot(epcdata, 'Phosphorus- Total', 'mg/L', station_colname, selsit),
