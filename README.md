...
For this application to work the `allData.parquet` file produced by the ingestion and published in [this gdrive folder](https://drive.google.com/drive/folders/1QMUpJOwfAMG9dB_fYT0Yva3IBVRg27fr) must be placed in the `./data/` directory.
